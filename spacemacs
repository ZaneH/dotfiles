...
before packages are loaded."
  ...
  ;; Set sequence of org todo keywords (shift <- -> cycle)
  (setq org-todo-keywords '((sequence "TODO" "PROGRESS" "BLOCKED" "|" "DONE" "DELEGATED" "CANCELLED")))
...
This function is called at the very end of Spacemacs initialization."
  ...
  (custom-set-faces
   ...
   ;; Your init file should contain only one such instance.
   ;; If there is more than one, they won't work right.
   '(merlin-type-face ((t (:inherit caml-types-expr-face :background "gray42"))))
   '(secondary-selection ((t (:extend t :background "gray24")))))
  )
